...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.send_header("Content-Type", "application/json")
        self.end_headers()
        self.wfile.write(json.dumps({"ok": True, "service": "financial-agent"}).encode())

if __name__ == "__main__":
    print("[FinancialServer] :7785")
    HTTPServer(("0.0.0.0", 7785), Handler).serve_forever()
