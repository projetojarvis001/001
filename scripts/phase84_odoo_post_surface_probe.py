...
out_json = base / f"phase84_odoo_post_surface_probe_{ts}.json"
out_md = docs / f"phase84_odoo_post_surface_probe_{ts}.md"
...
out_md.write_text(
f"""# FASE 84 — ODOO Post Surface Probe
...
print(f"[OK] post surface probe gerado em {out_json}")
