...
CHAT="8206117553"
DB_CONN="postgresql://jarvin_user:jarvin_pass@localhost:5433/jarvin"
...
CONTRATOS=$(docker exec jarvin-universal-postgres-1 psql -U jarvin_user -d jarvin \
...
TASKS=$(docker exec jarvin-universal-postgres-1 psql -U jarvin_user -d jarvin \
...
LEADS_FRIOS=$(docker exec jarvin-universal-postgres-1 psql -U jarvin_user -d jarvin \
