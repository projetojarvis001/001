...
out_json = BASE / f"phase87_odoo_smoke_rpc_probe_{ts}.json"
out_md = DOCS / f"phase87_odoo_smoke_rpc_probe_{ts}.md"
...
out_md.write_text(
f"""# FASE 87 — ODOO Smoke RPC Probe
...
print(f"[OK] smoke rpc probe gerado em {out_json}")
